...
- (id)initWithTitle:(NSString *)title{
    ...
    if (self = [super initWithFrame:CGRectMake(10, [UIScreen mainScreen].bounds.size.height - 60, [UIScreen mainScreen].bounds.size.width - 20, 46)]){
    
        UIImage *originalImage = [UIImage imageNamed:@"VideoBGImg"];
        ...
        _txtLabel = [[UILabel alloc]initWithFrame:CGRectMake(50, 12, self.frame.size.width - 5, 20)];
        ...
        //关闭按钮
        UIButton *closeBtn = [[UIButton alloc]initWithFrame:CGRectMake(12, 12, 22, 22)];
        [closeBtn setBackgroundImage:[UIImage imageNamed:@"CloseBtnImg"] forState:UIControlStateNormal];
        [closeBtn setTitle:@"" forState:UIControlStateNormal];
        [closeBtn addTarget:self action:@selector(hide) forControlEvents:UIControlEventTouchDown];
        
        [self addSubview:closeBtn];
//        [self setAccessoryView:closeBtn];
